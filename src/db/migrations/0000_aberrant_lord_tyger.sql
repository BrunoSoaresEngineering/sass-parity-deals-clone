...
CREATE TABLE IF NOT EXISTS "product_customizations" (
	...
	"backgorund_color" text DEFAULT 'hsl(193, 82%, 31%)' NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "products" ADD CONSTRAINT "products_clerk_user_id_user_subscriptions_clerk_user_id_fk" FOREIGN KEY ("clerk_user_id") REFERENCES "public"."user_subscriptions"("clerk_user_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
